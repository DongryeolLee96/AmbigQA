...
def main():
    ...
    ## Basic parameters
    parser.add_argument("--task", default="qa", choices=["dpr", "qa", "qg", "cqg", "cqa"],
                        type=str)
    ...
    parser.add_argument("--predict_file", default="data/nqopen/dev.json",
                        type=str)
    parser.add_argument("--ablation", default="", choices=["", "without_answers", "with_predicted_answers"], type=str)
    parser.add_argument("--predicted_answers_path", default="",
                        help="To infer with predicted answers, need to put json file containing predicted answers", type=str)
    parser.add_argument("--original_predict_file", default="",
                        help="This is used for CAmbigQA. Need to put gold dev set containing all answers for evaluation", type=str)
    ...
    if args.do_train and args.ablation in ["without_answers", "with_predicted_answers"]:
        raise ValueError("Do not train with incomplete answers")
